...
#-----------------------------------------------------------------------------------------
# Script information
script_name='PYLIS - PYTHON3 LIBRARIES FOR PACKAGE - NAME TYPE - CONDA'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	source activate $fp_env_folder_libraries
	conda install -c conda-forge python numpy pandas matplotlib scipy pip jupyter jupyterlab ipykernel openpyxl
